...
public abstract class Button extends Rectangle implements AListener {
    ...
    private void drawShape(Graphics g){
        ...
        if(shape != null){
            ...
            if (shape instanceof Circle || shape instanceof Etriangle || shape instanceof Pent)
