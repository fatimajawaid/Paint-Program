...
public abstract class ToolBar extends Rectangle implements AListener {
    ...
    public void paint(Graphics g) {
        ...
        if (title.length() > 0) {
            ...
            if (titleOnTop) {
                g.setColor(new Color(143, 93, 93, 71));
